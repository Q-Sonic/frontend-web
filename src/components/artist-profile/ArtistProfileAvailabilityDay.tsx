...
export function ArtistProfileAvailabilityDay({
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className={`relative shrink-0 flex flex-col items-center justify-center min-w-[48px] sm:min-w-[52px] flex-1 max-w-[72px] rounded-xl px-2 py-3 text-center transition focus:outline-none focus-visible:ring-2 focus-visible:ring-white/30 cursor-pointer ${
