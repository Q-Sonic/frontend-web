      ...
      >
        <div className="flex justify-end">
          <button
            type="button"
            onClick={onCancel}
            className="rounded-full border border-white/15 p-2 text-white/60 transition hover:border-white/25 hover:text-white"
            aria-label="Cerrar"
          >
        ...
        <div className="mt-8 flex flex-col-reverse gap-3 sm:flex-row sm:justify-end sm:gap-3">
          <Button
            ...
            variant="outline"
            onClick={onCancel}
            className="rounded-full border-[#00CCCB]/45 px-6 py-2.5 text-sm sm:w-auto"
          >
            {cancelLabel}
          </Button>
          <Button
