...
import { listArtistProfiles } from '../../services';
    ...
    <div className="min-h-screen bg-neutral-950 text-neutral-100 flex">
      ...
      <aside className="w-56 shrink-0 border-r border-neutral-800 flex flex-col bg-neutral-900">
        ...
        <nav className="p-2 flex-1">
          <Link to="/home/cliente" className="flex items-center gap-2 px-3 py-2 rounded-lg bg-violet-500/20 text-violet-300">
            Inicio
          </Link>
          <Link to="/profile/cliente" className="flex items-center gap-2 px-3 py-2 rounded-lg text-neutral-400 hover:text-white hover:bg-neutral-800">
            Mi perfil
          </Link>
        </nav>
      </aside>
