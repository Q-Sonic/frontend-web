...
export function ProfileOrganizacionPage() {
  ...
  return (
    <div className="max-w-md mx-auto w-full px-4 py-8">
      <h1 className="text-3xl font-bold text-white mb-6">Mi Perfil (Organización)</h1>
        ...
        <div className="space-y-6">
          ...
          <dl className="grid grid-cols-1 gap-x-4 gap-y-6 sm:grid-cols-2">
            ...
            <div>
              ...
              <dd className="mt-1">
                <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-violet-400/10 text-violet-400 capitalize">
                  {user.role}
                </span>
              </dd>
            </div>
